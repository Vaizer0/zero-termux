...
```bash
zero uninstall ai --cursor-cli
```

## Update

```bash
zero update ai --cursor-cli
```

## Notes

- **Native mode** requires `glibc-repo`, `glibc`, and other dependencies (installed automatically)
- The package is stored in `~/.local/share/zero-termux-data/cursor/`
