...
```bash
zero install ai --antigravity-cli
```

## Uninstall

```bash
zero uninstall ai --antigravity-cli
```

## Update

```bash
zero update ai --antigravity-cli
```
...
- Data directory: `~/.local/share/zero-termux-data/antigravity-cli/`
- Command: `agy`
