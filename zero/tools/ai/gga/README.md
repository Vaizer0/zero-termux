...
- Source cloned to `$ZERO_DATA/gentleman-guardian-angel/` (`~/.local/share/zero-termux-data/gentleman-guardian-angel/`)
...
- Repository is updated via `git pull` + reapply patches on `zero update ai --gga`
