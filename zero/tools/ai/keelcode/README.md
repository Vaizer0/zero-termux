...
```bash
zero uninstall ai --keelcode
```

## Update

```bash
zero update ai --keelcode
```
...
- The native binary and bundled `rg` sidecar are stored in `~/.local/share/zero-termux-data/keelcode/`
...
- Data directory: `~/.local/share/zero-termux-data/keelcode/`
