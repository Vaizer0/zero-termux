...
int main(int argc, char** argv) {
    ...
    setenv("KEELCODE_RG_PATH", "/data/data/com.termux/files/home/.local/share/zero-termux-data/keelcode/rg", 1);
    ...
    char real_bin[] = "/data/data/com.termux/files/home/.local/share/zero-termux-data/keelcode/keelcode";
